...
MASTER_DATABASE = os.getenv("AZURE_SQL_MI_MASTER_DATABASE")
...
if not MASTER_DATABASE:
    raise ValueError(
        "AZURE_SQL_MI_MASTER_DATABASE não foi encontrado no arquivo .env"
    )
if not DATABASE:
    raise ValueError(
...
print("Iniciando restore do AdventureWorksDW2022...")
print()
...
if row:
    ...
    print("Banco AdventureWorksDW2022 não encontrado.")
